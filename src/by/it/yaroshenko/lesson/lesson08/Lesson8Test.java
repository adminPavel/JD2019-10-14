package by.it.yaroshenko.lesson.lesson08;

import by.it.a_khmelev.lesson08.A_Knapsack;
import by.it.a_khmelev.lesson08.B_Knapsack;
import by.it.a_khmelev.lesson08.C_Stairs;
...
public class Lesson8Test {
    ...
    public void A() throws Exception {
        ...
        by.it.a_khmelev.lesson08.A_Knapsack instance = new A_Knapsack();
    ...
    public void B() throws Exception {
        ...
        by.it.a_khmelev.lesson08.B_Knapsack instance = new B_Knapsack();
        int res=instance.getMaxWeight(stream);
    ...
    public void C() throws Exception {
        ...
        by.it.a_khmelev.lesson08.C_Stairs instance = new C_Stairs();
