...
public class TaskB {
    ...
    public static void main(String[] args) {
        String filename = FileName.getFileName("TaskB.txt");
        readFile(filename);
        writeFile();
        showFile();
    }
    ...
    private static void writeFile() {
        String fileNameForWrite = FileName.getFileName("TaskB.txt");
    ...
    private static void showFile() {
        try (BufferedReader br = new BufferedReader(new FileReader(FileName.getFileName("TaskB.txt")))) {
