...
class TaskB1 {
    public static void main(String[] args) {
        Scanner sc=new Scanner(System.in);  //метод получения значения с клавиатуры
        int i=sc.nextInt();                 //ожидаемая переменная инт.
        System.out.println(i*i);            //вывод на экран квадрата полученного числа
